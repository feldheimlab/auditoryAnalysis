...
def probeMapFromMeta(meta_path):
	...
	# Parse all parenthesized entries
	entries = []
	...
	# First entry is header: probe_type,num_shanks,shank_spacing,shank_width
	header = entries[0].split(',')
	shank_spacing = float(header[2])

	# Remaining entries are channel geometry: shank:x:y:used
	channels = []
